...
const Navbar = () => {
    ...
    const { User, setUser, setShowUserLogin, navigate, setSearchQuery, SearchQuery, cartItems, setCartItems, axios } = useAppContext();
    ...
    const handleSearch = (e) => {
        ...
        if (value.length > 0 && !window.location.pathname.includes('/products')) {
            navigate('/products');
        }
    };
