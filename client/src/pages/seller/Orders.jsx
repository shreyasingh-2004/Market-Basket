...
const Orders = () => {
    ...
    return (
        <div className='no-scrollbar overflow-y-scroll h-[95vh] flex-1 '>
            <div className="md:p-10 p-4 space-y-4">
                <h2 className="text-lg font-medium">Orders List</h2>
                {orders.map((order, index) => (
                    <div key={index} className="flex flex-col md:grid md:items-center md:flex-row gap-5 p-5 max-w-4xl rounded-md border border-gray-300">
                        ...
                        <p className="font-medium text-auto my-auto">
